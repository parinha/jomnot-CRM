...
import { useStore, type ProjectStatus } from '../AppStore';
...
// Lunar/variable holidays (YYYY-MM-DD keyed)
const LUNAR_HOLIDAYS: Record<string, string> = {
  ...
  // Water Festival / Bon Om Touk (3 days)
  ...
  return (
    <>
      ...
      >
        {mode === 'month'
          ? monthGroups.map((g, i) => {
              // Check if this month has any holiday
              const hasHoliday =
                showHolidays &&
                (() => {
