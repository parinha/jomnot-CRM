...
export const STATUS_CONFIG: Record<InvoiceStatus, {
  ...
  draft:   { label: 'Draft',        cls: 'bg-zinc-100 text-zinc-600',   color: 'text-zinc-600',  bg: 'bg-zinc-50 border-zinc-200',   bar: 'bg-zinc-400'  },
  sent:    { label: 'Sent',         cls: 'bg-blue-100 text-blue-700',   color: 'text-blue-700',  bg: 'bg-blue-50 border-blue-200',   bar: 'bg-blue-500'  },
  partial: { label: 'Deposit Rcvd', cls: 'bg-amber-100 text-amber-700', color: 'text-amber-700', bg: 'bg-amber-50 border-amber-200', bar: 'bg-amber-500' },
  paid:    { label: 'Paid',         cls: 'bg-green-100 text-green-700', color: 'text-green-700', bg: 'bg-green-50 border-green-200', bar: 'bg-green-500' },
  overdue: { label: 'Overdue',      cls: 'bg-red-100 text-red-600',     color: 'text-red-700',   bg: 'bg-red-50 border-red-200',     bar: 'bg-red-500'   },
}
